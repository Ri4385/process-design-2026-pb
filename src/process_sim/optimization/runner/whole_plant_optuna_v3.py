"""全体プラント年収支を目的関数にする Optuna runner v3。"""
...
LOG_DIR = Path("logs")
LOG_PATH = LOG_DIR / "whole_plant_optuna_v3.log"
DETAIL_LOG_PATH = LOG_DIR / "whole_plant_optuna_v3_detail.log"
...
TARGET_EFFECTIVE_TRIALS_BY_STUDY: dict[str, int] = {
    "radial_2stage_whole_plant_profit_v3": 100,
    "radial_3stage_whole_plant_profit_v3": 0,
    "axial_2stage_whole_plant_profit_v3": 0,
    "axial_3stage_whole_plant_profit_v3": 0,
}

TWO_STAGE_WHOLE_PLANT_V3_RADIAL_BED_THICKNESS_RANGE_M = ParameterRange(
    lower=0.6,
    upper=1.0,
)

TWO_STAGE_RADIAL_WHOLE_PLANT_V3_CONFIG = replace(
    TWO_STAGE_WHOLE_PLANT_V2_RADIAL_REACTOR_PARAMETER_CONFIG,
    bed_thicknesses_m=(
        TWO_STAGE_WHOLE_PLANT_V3_RADIAL_BED_THICKNESS_RANGE_M,
        TWO_STAGE_WHOLE_PLANT_V3_RADIAL_BED_THICKNESS_RANGE_M,
    ),
)
THREE_STAGE_RADIAL_WHOLE_PLANT_V3_CONFIG = (
    THREE_STAGE_WHOLE_PLANT_V2_RADIAL_REACTOR_PARAMETER_CONFIG
)
...
STUDY_CONFIGS: tuple[StudyConfig, ...] = (
    StudyConfig(
        study_name="radial_2stage_whole_plant_profit_v3",
        reactor_type="radial",
        reactor_model="radial",
        parameter_config=TWO_STAGE_RADIAL_WHOLE_PLANT_V3_CONFIG,
    ),
    StudyConfig(
        study_name="radial_3stage_whole_plant_profit_v3",
        reactor_type="radial",
        reactor_model="radial",
        parameter_config=THREE_STAGE_RADIAL_WHOLE_PLANT_V3_CONFIG,
    ),
    StudyConfig(
        study_name="axial_2stage_whole_plant_profit_v3",
        reactor_type="axial",
        reactor_model="pfr",
        parameter_config=TWO_STAGE_AXIAL_WHOLE_PLANT_CONFIG,
    ),
    StudyConfig(
        study_name="axial_3stage_whole_plant_profit_v3",
        reactor_type="axial",
        reactor_model="pfr",
...
def tune_whole_plant_optuna_v3_main() -> None:
...
if __name__ == "__main__":
    tune_whole_plant_optuna_v3_main()
