"""全体プラント年収支を目的関数にする Optuna runner v4。"""
...
from process_sim.optimization.separator.parameters import (
    DECANTER_1_TEMPERATURE_RANGE_C,
    SM_COLUMN_REFLUX_RATIO_RANGE,
...
LOG_DIR = Path("logs")
LOG_PATH = LOG_DIR / "whole_plant_optuna_v4.log"
DETAIL_LOG_PATH = LOG_DIR / "whole_plant_optuna_v4_detail.log"
...
TARGET_EFFECTIVE_TRIALS_BY_STUDY: dict[str, int] = {
    "radial_2stage_whole_plant_profit_v4": 200,
    "radial_3stage_whole_plant_profit_v4": 200,
    "axial_2stage_whole_plant_profit_v4": 0,
    "axial_3stage_whole_plant_profit_v4": 0,
}

TWO_STAGE_WHOLE_PLANT_V4_RADIAL_BED_THICKNESS_RANGE_M = ParameterRange(
    lower=0.6,
    upper=1.0,
)

TWO_STAGE_RADIAL_WHOLE_PLANT_V4_CONFIG = replace(
    TWO_STAGE_WHOLE_PLANT_V2_RADIAL_REACTOR_PARAMETER_CONFIG,
    bed_thicknesses_m=(
        TWO_STAGE_WHOLE_PLANT_V4_RADIAL_BED_THICKNESS_RANGE_M,
        TWO_STAGE_WHOLE_PLANT_V4_RADIAL_BED_THICKNESS_RANGE_M,
    ),
)
THREE_STAGE_RADIAL_WHOLE_PLANT_V4_CONFIG = (
    THREE_STAGE_WHOLE_PLANT_V2_RADIAL_REACTOR_PARAMETER_CONFIG
)
...
STUDY_CONFIGS: tuple[StudyConfig, ...] = (
    StudyConfig(
        study_name="radial_2stage_whole_plant_profit_v4",
        reactor_type="radial",
        reactor_model="radial",
        parameter_config=TWO_STAGE_RADIAL_WHOLE_PLANT_V4_CONFIG,
    ),
    StudyConfig(
        study_name="radial_3stage_whole_plant_profit_v4",
        reactor_type="radial",
        reactor_model="radial",
        parameter_config=THREE_STAGE_RADIAL_WHOLE_PLANT_V4_CONFIG,
    ),
    StudyConfig(
        study_name="axial_2stage_whole_plant_profit_v4",
        reactor_type="axial",
        reactor_model="pfr",
        parameter_config=TWO_STAGE_AXIAL_WHOLE_PLANT_CONFIG,
    ),
    StudyConfig(
        study_name="axial_3stage_whole_plant_profit_v4",
        reactor_type="axial",
        reactor_model="pfr",
...
def tune_whole_plant_optuna_v4_main() -> None:
...
def objective(trial: optuna.Trial, config: StudyConfig) -> float:
    ...
    separator_candidate = suggest_separator_candidate(trial=trial)
...
def suggest_separator_candidate(trial: optuna.Trial) -> SeparatorOperatingCandidate:
    """探索空間から分離器操作候補を生成する。"""
    return SeparatorOperatingCandidate(
        decanter_1_temperature_c=suggest_float(
            trial,
            "decanter_1_temperature_c",
            DECANTER_1_TEMPERATURE_RANGE_C,
        ),
        sm_column_reflux_ratio=suggest_float(
            trial,
...
if __name__ == "__main__":
    tune_whole_plant_optuna_v4_main()
