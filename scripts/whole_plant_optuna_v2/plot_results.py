"""全体最適化 v2 の Optuna storage から図と表を生成する。"""
...
MEDIA_DIR = Path("scripts") / "whole_plant_optuna_v2" / "media"
RESULTS_DIR = Path("scripts") / "whole_plant_optuna_v2" / "results"
STUDY_NAMES: tuple[str, ...] = (
    "radial_2stage_whole_plant_profit_v2",
    "radial_3stage_whole_plant_profit_v2",
    "axial_2stage_whole_plant_profit_v2",
    "axial_3stage_whole_plant_profit_v2",
)
TOP_TRIAL_COUNT = 10
...
def plot_whole_plant_optuna_v2_main() -> None:
    """全体最適化 v2 の保存済み study から図と表を生成する。"""
...
if __name__ == "__main__":
    plot_whole_plant_optuna_v2_main()
