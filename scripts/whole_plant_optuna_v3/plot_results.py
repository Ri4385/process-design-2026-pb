"""全体最適化 v3 の Optuna storage から図と表を生成する。"""
...
STORAGE_PATH = Path("data") / "optuna" / "whole_plant_optuna_v3.db"
MEDIA_DIR = Path("scripts") / "whole_plant_optuna_v3" / "media"
RESULTS_DIR = Path("scripts") / "whole_plant_optuna_v3" / "results"
STUDY_NAMES: tuple[str, ...] = (
    "radial_2stage_whole_plant_profit_v3",
    "radial_3stage_whole_plant_profit_v3",
    "axial_2stage_whole_plant_profit_v3",
    "axial_3stage_whole_plant_profit_v3",
)
TOP_TRIAL_COUNT = 10
...
def plot_whole_plant_optuna_v3_main() -> None:
    """全体最適化 v3 の保存済み study から図と表を生成する。"""
...
if __name__ == "__main__":
    plot_whole_plant_optuna_v3_main()
